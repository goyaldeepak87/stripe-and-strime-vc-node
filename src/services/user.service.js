...
const createGuestUser = async (userBody) => {
    const { email, password, role, user_name } = userBody;
...
const RegiterEmailVerifyGuestUser = async (UserId) => {
    
    return GuestUser.findOne({ where: { uuid : UserId?.id} });
};
const GuestUserEmailVerifyUpdate = async (UserId) => {
...
module.exports = { createUser,GuestUserEmailVerifyUpdate, RegiterEmailVerifyGuestUser, getUserByEmail, getUserById, updateUserByPassword, userProfileUpdate, createGuestUser };
